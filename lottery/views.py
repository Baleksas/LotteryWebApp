...
def view_draws():
    ...
    # get all draws that have not been played [played=0] and for current user only
    ...
    playable_draws_copy = list(map(lambda x: copy.deepcopy(x), playable_draws))
    ...
    if len(playable_draws) != 0:
        # decrypt every draw
        for draw in playable_draws_copy:
